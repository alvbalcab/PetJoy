"""Ajustes (settings) del proyecto `tienda_online`.

Este archivo contiene la configuración principal de Django para el
proyecto: apps instaladas, middleware, bases de datos, autenticación,
archivos estáticos y parámetros de terceros (Stripe, drf-spectacular).
No modifiques valores sensibles en producción sin usar variables de
entorno o un sistema de gestión de secretos.
"""
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'PetJoy API', # Título de tu documentación
